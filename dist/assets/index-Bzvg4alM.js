...
var e=Object.defineProperty,t=Object.getOwnPropertyDescriptor,n=Object.getOwnPropertyNames,r=Object.prototype.hasOwnProperty,i=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},a=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),o=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r},s=(i,a,o,s)=>{if(a&&typeof a==`object`||typeof a==`function`)for(var c=n(a),l=0,u=c.length,d;l<u;l++)d=c[l],!r.call(i,d)&&d!==o&&e(i,d,{get:(e=>a[e]).bind(null,d),enumerable:!(s=t(a,d))||s.enumerable});return i},c=t=>r.call(t,`module.exports`)?t[`module.exports`]:s(e({},`__esModule`,{value:!0}),t),l=(e=>typeof require<`u`?require:typeof Proxy<`u`?new Proxy(e,{get:(e,t)=>(typeof require<`u`?require:e)[t]}):e)(function(e){if(typeof require<`u`)return require.apply(this,arguments);throw Error('Calling `require` for "'+e+"\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.")});(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var u=i((()=>{}));function d(){return sessionStorage.getItem(`admin`)===`true`}function f(e){return e===p?(sessionStorage.setItem(`admin`,`true`),!0):!1}var p,ee=i((()=>{p=`NWOFoundry2026`}));function m(e){let t=prompt(`Administrator Password`);t!==null&&(f(t)?e():alert(`Incorrect password.`))}var h=i((()=>{ee()}));function te(){let e=document.querySelectorAll(`.page`),t=document.querySelectorAll(`.nav-button, .subnav-button`),n=n=>{let r=document.getElementById(n);if(!r)return;e.forEach(e=>e.classList.remove(`active`)),t.forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`[data-page="${n}"]`).forEach(e=>{let t=e.dataset.navGroup;t&&document.querySelectorAll(`[data-nav-group="${t}"]`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`)});let i=_(n);[`foundry`,`canyon`].includes(i)&&(document.querySelector(`[data-nav-group="main"][data-page="events"]`)?.classList.add(`active`),document.querySelector(`[data-nav-group="${i}"][data-page="${n}"]`)?.classList.add(`active`)),r.classList.add(`active`)},r=e=>{let t=()=>{n(e);let t=`#${e}`;globalThis.location.hash!==t&&globalThis.history.pushState(null,``,t)};if(e===`import`&&!d()){m(t);return}t()};t.forEach(e=>{e.addEventListener(`click`,()=>{r(e.dataset.page)})}),globalThis.addEventListener(`hashchange`,()=>{r(g())}),r(g())}function g(){return globalThis.location.hash.replace(`#`,``)||`events`}function _(e){return document.querySelector(`[data-page="${e}"]`)?.dataset.navGroup??null}var v=i((()=>{ee(),h()})),y,b=i((()=>{y=[{id:`nick`,displayName:`Nicholas`},{id:`kazuma`,displayName:`Kazuma`},{id:`nooch`,displayName:`Nooch`}]})),x,S=i((()=>{x=[]})),C,ne=i((()=>{C={opening:{boiler:[{chief:`nick`,assignment:`Lead`},{chief:`kazuma`,assignment:`Support`}],"workshop-west":[{chief:`nooch`,assignment:`Lead`}],"prototype-west":[]},mid:{"prototype-west":[{chief:`nick`,assignment:`Lead`}],"prototype-east":[{chief:`kazuma`,assignment:`Lead`}],mercenary:[{chief:`nooch`,assignment:`Lead`}]},final:{imperial:[{chief:`nick`,assignment:`Support`}]}}})),w,re=i((()=>{w={strategyName:`Legion 2 Standard`,version:`0.2.0`,commander:`Kazuma`,eventDate:``,eventDuration:60,phases:{opening:{label:`0–15 Minutes`},mid:{label:`15–45 Minutes`},final:{label:`45 Minutes–End`}}}})),T,E=i((()=>{T=[{id:`boiler`,name:`Boiler`,x:30,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Building capture speed buff.`},mid:{priority:`Critical`,strategy:`Maintain control.`,why:`Critical Phase 2 control objective.`},final:{priority:`Critical`,strategy:`Maintain control.`,why:`Critical Phase 3 control objective.`}}},{id:`repair-north`,name:`North Repair`,x:58,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if available.`,why:`Extra points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Medium Phase 3 support value.`}}},{id:`workshop-northwest`,name:`NW Workshop`,x:20,y:15,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`mercenary`,name:`Mercenary Camp`,x:45,y:15,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Critical`,strategy:`Capture immediately.`,why:`Critical Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 3 objective.`}}},{id:`workshop-northeast`,name:`NE Workshop`,x:70,y:20,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`prototype-west`,name:`West Prototype`,x:20,y:30,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture immediately.`,why:`High Phase 1 objective.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control if practical.`,why:`Equal high-priority Prototype objective.`}}},{id:`repair-west`,name:`West Repair`,x:10,y:40,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Low Phase 3 support value.`}}},{id:`imperial`,name:`Imperial Foundry`,x:45,y:35,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`High`,strategy:`Capture and contest.`,why:`High Phase 2 objective.`},final:{priority:`Critical`,strategy:`Primary objective.`,why:`Highest value objective.`}}},{id:`repair-east`,name:`East Repair`,x:80,y:35,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Low Phase 3 support value.`}}},{id:`prototype-east`,name:`East Prototype`,x:70,y:45,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture immediately.`,why:`High Phase 1 objective.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control if practical.`,why:`Equal high-priority Prototype objective.`}}},{id:`workshop-southwest`,name:`SW Workshop`,x:26,y:55,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`workshop-southeast`,name:`SE Workshop`,x:61,y:60,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`munitions`,name:`Munitions Factory`,x:45,y:60,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Critical`,strategy:`Capture immediately.`,why:`Powerful combat buff.`},final:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 3 objective.`}}},{id:`repair-south`,name:`South Repair`,x:31,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Medium Phase 3 support value.`}}},{id:`transit`,name:`Transit Station`,x:60,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Major mobility advantage.`},mid:{priority:`Medium`,strategy:`Hold if practical.`,why:`Medium Phase 2 rotation value.`},final:{priority:`Low`,strategy:`Use only when needed for rotations.`,why:`Lower Phase 3 priority.`}}}]})),D,O,ie,k,ae=i((()=>{D=`modulepreload`,O=function(e){return`/`+e},ie={},k=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=O(t,n),t=s(t),t in ie)return;ie[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:D,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));function A(){return oe().length===0}function oe(){return Object.entries(le).filter(([,e])=>!e).map(([e])=>e)}function j(){return{configured:A(),missingKeys:oe()}}async function se(){if(!A())return null;if(!N){let{initializeApp:e}=await k(async()=>{let{initializeApp:e}=await import(`./index.esm-Dcbs7p1T.js`);return{initializeApp:e}},__vite__mapDeps([0,1]));N=e(M)}return N}async function ce(){if(!A())return null;if(!P){let[e,{getFirestore:t}]=await Promise.all([se(),k(()=>import(`./index.esm-CRF_LMY8.js`),__vite__mapDeps([2,1]))]);P=t(e)}return P}var M,le,N,P,ue=i((()=>{ae(),M={apiKey:`AIzaSyDnOfdz8WQsvxr5oJaFzS8EdNJtdsQYgqQ`,authDomain:`wos-command-center.firebaseapp.com`,projectId:`wos-command-center`,storageBucket:`wos-command-center.firebasestorage.app`,messagingSenderId:`853155306331`,appId:`1:853155306331:web:f37dc257fa6950d0f2d87e`},le={VITE_FIREBASE_API_KEY:M.apiKey,VITE_FIREBASE_PROJECT_ID:M.projectId,VITE_FIREBASE_APP_ID:M.appId},N=null,P=null}));function de(){let e=globalThis.location?.hostname;return e===`localhost`||e===`127.0.0.1`||e===``}function fe(e,t){if(!e.exists())return R[t];let n=e.data();return Array.isArray(R[t])?Array.isArray(n.items)?n.items:R[t]:n.value??n}function pe(e,t){return Promise.race([e,new Promise((e,n)=>{setTimeout(()=>n(Error(t)),we)})])}function me(e){return e?.code===`unavailable`||e?.message?.toLowerCase().includes(`client is offline`)||e?.message?.toLowerCase().includes(`offline`)}function he(e){return me(e)?Error(`Combatants were not saved. Firestore is configured, but the app cannot reach Firebase from this browser. Check network access, Firestore setup, and Firebase Hosting env build settings.`):Error(`Combatants were not saved to Firebase. ${e.message}`)}async function ge(){if(!A()){if(!de()){let e=j();console.warn(`Firebase is not configured. Using bundled local data fallback.`,e.missingKeys)}return R}try{let[e,{doc:t,getDoc:n}]=await Promise.all([ce(),k(()=>import(`./index.esm-CRF_LMY8.js`),__vite__mapDeps([2,1]))]);if(!e)return R;let r=await Promise.all(Object.entries(Ce).map(async([r,i])=>[r,fe(await pe(n(t(e,Se,i)),`Timed out loading ${i} from Firebase.`),r)]));R={...R,...Object.fromEntries(r)}}catch(e){console.warn(`Using bundled command data fallback.`,e)}return R}async function _e(e,t){let n=Ce[e];if(!n)throw Error(`Unknown command data key: ${e}`);if(!A()){if(!de()){let e=j();throw Error(`Firebase is not configured. Missing: ${e.missingKeys.join(`, `)}. Production combatant changes cannot be saved.`)}return R={...R,[e]:t},R[e]}let[r,{doc:i,serverTimestamp:a,setDoc:o}]=await Promise.all([ce(),k(()=>import(`./index.esm-CRF_LMY8.js`),__vite__mapDeps([2,1]))]);if(!r)return R={...R,[e]:t},R[e];let s=Array.isArray(t)?{items:t}:{value:t};try{await pe(o(i(r,Se,n),{...s,updatedAt:a()},{merge:!0}),`Timed out saving ${n} to Firebase.`)}catch(e){throw he(e)}return R={...R,[e]:t},R[e]}function ve(){return R.chiefs}function ye(){return R.combatants}function F(){let e=ye();return e.length>0?e.map(e=>({...e,displayName:e.name,source:`combatants`})):ve().map(e=>({...e,name:e.displayName,source:`chiefs`}))}function I(e){return F().find(t=>t.id===e)}function be(){return R.foundryAssignments}function xe(){return R.foundryConfig}function L(){return R.foundryObjectives}var R,Se,Ce,we,z=i((()=>{b(),S(),ne(),re(),E(),ue(),ae(),R={chiefs:y,combatants:x,foundryAssignments:C,foundryConfig:w,foundryObjectives:T},Se=`commandData`,Ce={chiefs:`chiefs`,combatants:`combatants`,foundryAssignments:`foundryAssignments`,foundryConfig:`foundryConfig`,foundryObjectives:`foundryObjectives`},we=8e3}));function Te(e,t){if(!e)return[];let n=[],r=ke(e,t);r.length>0&&n.push(...r);let i=be()[t];return i&&Object.entries(i).forEach(([t,r])=>{r.forEach(r=>{r.chief===e&&n.push({objectiveId:t,assignment:r.assignment})})}),n}function Ee(e,t,n){return Te(e,t).find(e=>e.objectiveId===n)}function De(e,t,n=null){return F().filter(e=>e.source===`combatants`&&(!n||e.legion===n)).map(e=>({combatant:e,assignments:ke(e.id,t)})).flatMap(t=>t.assignments.filter(t=>t.objectiveId===e).map(e=>({combatant:t.combatant,assignment:e})))}function Oe(e,t){let n=new Map;return F().filter(t=>t.source===`combatants`&&t.legion===e).forEach(e=>{ke(e.id,t).forEach(t=>{t.objectiveId&&(n.has(t.objectiveId)||n.set(t.objectiveId,[]),n.get(t.objectiveId).push({combatant:e,assignment:t}))})}),[...n.entries()].map(([e,t])=>({objectiveId:e,assignments:t}))}function ke(e,t){let n=I(e);if(!n||n.source!==`combatants`)return[];let r=n.assignment?.trim();if(!r||B(r)===`no engagement`)return[];let i=Ae(r);return i?je(n,i,t).map((e,t)=>({objectiveId:e,assignment:`${r} primary ${t+1}`,combatant:n})):[{objectiveId:$e(r),assignment:r,combatant:n}]}function Ae(e){let t=B(e);return t===`legion 1`?1:t===`legion 2`?2:null}function je(e,t,n){return Me(t,n).get(e.id)??[]}function Me(e,t){let n=t??`opening`,r=Ne(e,n),i=Ze(e),a=new Map(i.map(e=>[e.id,[]]));if(r.length===0||i.length===0)return a;let o=Pe(r,n),s=qe(r,n,i.length),c=new Map(r.map(e=>[e.id,0]));for(let t=0;t<tt;t+=1)i.forEach(t=>{let n=a.get(t.id),i=Xe(t,e)?He(o):o,l=Fe(r,n,c,s)??Ie(i,n,c,s);l&&(n.push(l.id),c.set(l.id,(c.get(l.id)??0)+1))});return a}function Ne(e,t){return(et[t]?.[e]??[]).map(e=>L().find(t=>t.id===e)).filter(Boolean)}function Pe(e,t){let n=[];for(let r=0;r<e.length-2;r+=1)for(let i=r+1;i<e.length-1;i+=1)for(let a=i+1;a<e.length;a+=1){let o=Be([e[r],e[i],e[a]],t);n.push({objectives:o,score:ze(o,t)})}return n.sort((e,t)=>t.score-e.score)}function Fe(e,t,n,r){return Re(e).find(e=>Le(e,t,n,r)&&(n.get(e.id)??0)===0)??null}function Ie(e,t,n,r){for(let i of e){let e=i.objectives.find(e=>Le(e,t,n,r));if(e)return e}return null}function Le(e,t,n,r){return t.includes(e.id)?!1:(n.get(e.id)??0)<(r.get(e.id)??0)}function Re(e){return[...e].sort((e,t)=>Ge(e)-Ge(t)||e.name.localeCompare(t.name))}function ze(e,t){let n=e.reduce((e,n)=>e+Ke(n,t),0),r=Ve(e),i=We(e)*rt;return n*nt-r-i}function Be(e,t){return[...e].sort((e,n)=>Ke(n,t)-Ke(e,t)||e.name.localeCompare(n.name))}function Ve(e){let[t,n,r]=e;return Ye(t,n)*it+Ye(t,r)*it+Ye(n,r)*at}function He(e){return[...e].sort((e,t)=>Ue(t)-Ue(e))}function Ue(e){return e.score-We(e.objectives)*st}function We(e){return e.reduce((e,t)=>e+Math.hypot(t.x-V.x,t.y-V.y),0)}function Ge(e){return Math.hypot(e.x-V.x,e.y-V.y)}function Ke(e,t){return ct[e.phases[t]?.priority?.toLowerCase()??`low`]??ct.low}function qe(e,t,n){return new Map(e.map(e=>[e.id,Je(e,t,n)]))}function Je(e,t,n){let r=lt[e.phases[t]?.priority?.toLowerCase()??`low`]??lt.low;return Math.max(1,Math.floor(n*r))}function Ye(e,t){return Math.hypot(e.x-t.x,e.y-t.y)}function Xe(e,t){let n=Ze(t),r=Math.max(1,Math.ceil(n.length*ot)),i=n.findIndex(t=>t.id===e.id);return i>=0&&i>=n.length-r}function Ze(e){return F().filter(t=>t.source===`combatants`&&t.legion===e&&B(t.assignment)!==`no engagement`).sort((e,t)=>Qe(t)-Qe(e)||e.displayName.localeCompare(t.displayName))}function Qe(e){return e.troopPower??e.power??0}function $e(e){let t=B(e);return L().find(e=>B(e.id)===t||B(e.name)===t||t.includes(B(e.name)))?.id??null}function B(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,` `).trim()}var et,tt,nt,rt,it,at,ot,st,V,ct,lt,ut=i((()=>{z(),et={opening:{1:[`boiler`,`prototype-west`,`prototype-east`,`repair-west`,`repair-south`,`transit`],2:[`boiler`,`repair-north`,`prototype-west`,`prototype-east`,`repair-east`,`transit`]},mid:{1:[`boiler`,`prototype-west`,`prototype-east`,`repair-west`,`repair-south`,`mercenary`,`munitions`,`imperial`,`transit`],2:[`boiler`,`repair-north`,`prototype-west`,`prototype-east`,`repair-east`,`mercenary`,`munitions`,`imperial`,`transit`]},final:{1:[`boiler`,`imperial`,`prototype-west`,`prototype-east`,`munitions`,`mercenary`,`workshop-northwest`,`workshop-southwest`,`repair-west`,`repair-south`,`transit`],2:[`boiler`,`imperial`,`prototype-west`,`prototype-east`,`munitions`,`mercenary`,`workshop-northeast`,`workshop-southeast`,`repair-east`,`repair-north`,`transit`]}},tt=3,nt=100,rt=.25,it=2.5,at=1.5,ot=.1,st=2,V={x:100,y:50},ct={critical:4,high:3,medium:2,low:1},lt={critical:.4,high:.35,medium:.15,low:.1}}));function dt(){let e=document.getElementById(`my-objectives`),t=Et();if(!e)return;e.innerHTML=``;let n=t?Te(t,_t()):Oe(Dt(),_t()).map(e=>({objectiveId:e.objectiveId,assignment:`${e.assignments.length} assigned combatants`}));if(n.length===0){e.innerHTML=`<p>No assignments this phase.</p>`;return}n.forEach(t=>{let n=L().find(e=>e.id===t.objectiveId),r=document.createElement(`div`);r.className=`assignment-card`,r.innerHTML=`
    ...
    `:``}function ht(e){return e.troopPower??e.power??0}var gt=i((()=>{z(),Y(),ut(),G()}));function _t(){return U}function vt(e){W=e}function yt(e){return{critical:`🔴`,high:`🟠`,medium:`🟡`,low:`⚪`}[e.toLowerCase()]||`⚪`}function bt(e){let t={opening:0,mid:1,final:2};return t[U]>=t[e.unlockPhase]}function H(){let e=document.getElementById(`battlefield-map`);if(!e)return;e.innerHTML=``;let t=Et(),n=Te(t,U),r=Dt(),i=t?[]:Oe(r,U);L().forEach(r=>{let a=document.createElement(`div`);a.dataset.id=r.id,a.className=`objective`,a.style.left=r.x+`%`,a.style.top=r.y+`%`;let o=r.phases[U];a.classList.add(o.priority.toLowerCase());let s=bt(r);if(s||a.classList.add(`locked`),t){let e=n.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}else{let e=i.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}W&&W.id===r.id&&a.classList.add(`selected`),a.innerHTML=`
        ...
        `,a.onclick=()=>{W=r,H()},e.appendChild(a)}),W||=L()[0],xt(W),pt(),dt()}function xt(e){let t=document.getElementById(`objective-panel`);if(!t||!e)return;let n=e.phases[U],r=Ee(Et(),U,e.id),i=De(e.id,U,Dt());t.innerHTML=`
    ...
    `}function Ct(e){return e.troopPower??e.power??0}function wt(){let e=document.querySelectorAll(`.phase-button`);e.forEach(t=>{t.onclick=()=>{e.forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),U=t.dataset.phase,H()}})}var U,W,G=i((()=>{z(),Y(),ut(),ft(),gt(),U=`opening`,W=null}));function Tt(){let e=document.getElementById(`chief-search`),t=document.getElementById(`chief-list`);if(!e||!t)return;let n=localStorage.getItem(`chief`);if(n){let t=F().find(e=>e.id===n);t&&(q=t.id,e.value=t.displayName)}K(),e.addEventListener(`focus`,()=>{Ot(e.value)}),e.addEventListener(`input`,()=>{Ot(e.value),F().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase())||(q=null,localStorage.removeItem(`chief`),K(),H())}),e.addEventListener(`change`,()=>{let t=F().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase());if(!t){q=null,localStorage.removeItem(`chief`),K(),H();return}q=t.id,localStorage.setItem(`chief`,t.id),K(),H(),At()}),document.addEventListener(`click`,n=>{n.target===e||t.contains(n.target)||At()})}function Et(){return q}function Dt(){let e=I(q);return e?.legion?e.legion:Number.isFinite(J)?J:1}function K(){let e=document.getElementById(`legion-context`);if(!e)return;let t=I(q);if(t){e.innerHTML=`
            <label>Legion</label>
    ...
    `,e.querySelector(`#legion-select`).addEventListener(`change`,e=>{J=Number.parseInt(e.target.value,10),localStorage.setItem(`legion`,String(J)),H()})}function Ot(e){let t=document.getElementById(`chief-list`);if(!t)return;let n=e.trim().toLowerCase(),r=F().slice().sort((e,t)=>e.displayName.localeCompare(t.displayName)).filter(e=>!n||e.displayName.toLowerCase().includes(n));if(r.length===0){t.innerHTML=`<div class="chief-result-empty">No chiefs found.</div>`,t.hidden=!1;return}t.innerHTML=r.map(e=>`
            <button
                type="button"
                class="chief-result"
                data-chief-id="${e.id}">
    ...
    `;let i=document.getElementById(`roster-list`);r.forEach(e=>{let t=document.createElement(`div`);t.className=`roster-row`,t.innerHTML=`
        ...
        `,i.appendChild(t)})}function nr(e){return Array.isArray(e)&&e.length>0?e:F()}function rr(e){return e.troopPower??e.power??0}var ir=i((()=>{z()}));function ar(){let e=document.getElementById(`import-page`);e&&(e.innerHTML=`
        <div class="card">
    ...
    `,document.getElementById(`process-images`).addEventListener(`click`,async()=>{let e=document.getElementById(`event-select`).value,t=[...document.getElementById(`combatant-upload`).files];if(t.length===0){alert(`Please select one or more screenshots.`);return}let n=document.getElementById(`import-results`);n.innerHTML=`<p>Processing...</p>`;try{let r=await $n(e,t);$=r.flatMap(e=>e.combatants??[]).map(pr),sr(n,r)}catch(e){console.error(e),n.innerHTML=`
                ...
                `}}),document.getElementById(`load-current-combatants`).addEventListener(`click`,()=>{let e=document.getElementById(`import-results`);$=ye().map(pr),or(e)}))}function or(e){e.innerHTML=`
