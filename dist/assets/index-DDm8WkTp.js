...
var e=Object.defineProperty,t=Object.getOwnPropertyDescriptor,n=Object.getOwnPropertyNames,r=Object.prototype.hasOwnProperty,i=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},a=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),o=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r},s=(i,a,o,s)=>{if(a&&typeof a==`object`||typeof a==`function`)for(var c=n(a),l=0,u=c.length,d;l<u;l++)d=c[l],!r.call(i,d)&&d!==o&&e(i,d,{get:(e=>a[e]).bind(null,d),enumerable:!(s=t(a,d))||s.enumerable});return i},c=t=>r.call(t,`module.exports`)?t[`module.exports`]:s(e({},`__esModule`,{value:!0}),t),l=(e=>typeof require<`u`?require:typeof Proxy<`u`?new Proxy(e,{get:(e,t)=>(typeof require<`u`?require:e)[t]}):e)(function(e){if(typeof require<`u`)return require.apply(this,arguments);throw Error('Calling `require` for "'+e+"\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.")});(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var u=i((()=>{}));function d(){return sessionStorage.getItem(`admin`)===`true`}function f(e){return e===p?(sessionStorage.setItem(`admin`,`true`),!0):!1}var p,m=i((()=>{p=`NWOFoundry2026`}));function h(e){let t=prompt(`Administrator Password`);t!==null&&(f(t)?e():alert(`Incorrect password.`))}var g=i((()=>{m()}));function _(){let e=document.querySelectorAll(`.page`),t=document.querySelectorAll(`.nav-button, .subnav-button`),n=n=>{let r=document.getElementById(n);if(!r)return;e.forEach(e=>e.classList.remove(`active`)),t.forEach(e=>e.classList.remove(`active`)),document.querySelectorAll(`[data-page="${n}"]`).forEach(e=>{let t=e.dataset.navGroup;t&&document.querySelectorAll(`[data-nav-group="${t}"]`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`)});let i=y(n);[`foundry`,`canyon`].includes(i)&&(document.querySelector(`[data-nav-group="main"][data-page="events"]`)?.classList.add(`active`),document.querySelector(`[data-nav-group="${i}"][data-page="${n}"]`)?.classList.add(`active`)),r.classList.add(`active`)},r=e=>{let t=()=>{n(e);let t=`#${e}`;globalThis.location.hash!==t&&globalThis.history.pushState(null,``,t)};if(e===`import`&&!d()){h(t);return}t()};t.forEach(e=>{e.addEventListener(`click`,()=>{r(e.dataset.page)})}),globalThis.addEventListener(`hashchange`,()=>{r(v())}),r(v())}function v(){return globalThis.location.hash.replace(`#`,``)||`events`}function y(e){return document.querySelector(`[data-page="${e}"]`)?.dataset.navGroup??null}var b=i((()=>{m(),g()})),x,S=i((()=>{x=[{id:`nick`,displayName:`Nicholas`},{id:`kazuma`,displayName:`Kazuma`},{id:`nooch`,displayName:`Nooch`}]})),C,w=i((()=>{C=[]})),T,ee=i((()=>{T={opening:{boiler:[{chief:`nick`,assignment:`Lead`},{chief:`kazuma`,assignment:`Support`}],"workshop-west":[{chief:`nooch`,assignment:`Lead`}],"prototype-west":[]},mid:{"prototype-west":[{chief:`nick`,assignment:`Lead`}],"prototype-east":[{chief:`kazuma`,assignment:`Lead`}],mercenary:[{chief:`nooch`,assignment:`Lead`}]},final:{imperial:[{chief:`nick`,assignment:`Support`}]}}})),te,ne=i((()=>{te={strategyName:`Legion 2 Standard`,version:`0.2.0`,commander:`Kazuma`,eventDate:``,eventDuration:60,phases:{opening:{label:`0–15 Minutes`},mid:{label:`15–45 Minutes`},final:{label:`45 Minutes–End`}}}})),E,D=i((()=>{E=[{id:`boiler`,name:`Boiler`,x:30,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Building capture speed buff.`},mid:{priority:`Critical`,strategy:`Maintain control.`,why:`Critical Phase 2 control objective.`},final:{priority:`Critical`,strategy:`Maintain control.`,why:`Critical Phase 3 control objective.`}}},{id:`repair-north`,name:`North Repair`,x:58,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if available.`,why:`Extra points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Medium Phase 3 support value.`}}},{id:`workshop-northwest`,name:`NW Workshop`,x:20,y:15,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`mercenary`,name:`Mercenary Camp`,x:45,y:15,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Critical`,strategy:`Capture immediately.`,why:`Critical Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 3 objective.`}}},{id:`workshop-northeast`,name:`NE Workshop`,x:70,y:20,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`prototype-west`,name:`West Prototype`,x:20,y:30,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture immediately.`,why:`High Phase 1 objective.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control if practical.`,why:`Equal high-priority Prototype objective.`}}},{id:`repair-west`,name:`West Repair`,x:10,y:40,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Low Phase 3 support value.`}}},{id:`imperial`,name:`Imperial Foundry`,x:45,y:35,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`High`,strategy:`Capture and contest.`,why:`High Phase 2 objective.`},final:{priority:`Critical`,strategy:`Primary objective.`,why:`Highest value objective.`}}},{id:`repair-east`,name:`East Repair`,x:80,y:35,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Low Phase 3 support value.`}}},{id:`prototype-east`,name:`East Prototype`,x:70,y:45,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture immediately.`,why:`High Phase 1 objective.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 2 objective.`},final:{priority:`High`,strategy:`Maintain control if practical.`,why:`Equal high-priority Prototype objective.`}}},{id:`workshop-southwest`,name:`SW Workshop`,x:26,y:55,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`workshop-southeast`,name:`SE Workshop`,x:61,y:60,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},mid:{priority:`Low`,strategy:`Locked.`,why:`Unlocks in Phase 3.`},final:{priority:`Medium`,strategy:`Gather for points.`,why:`Secondary objective.`}}},{id:`munitions`,name:`Munitions Factory`,x:45,y:60,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Critical`,strategy:`Capture immediately.`,why:`Powerful combat buff.`},final:{priority:`High`,strategy:`Maintain control.`,why:`High Phase 3 objective.`}}},{id:`repair-south`,name:`South Repair`,x:31,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Low`,strategy:`Rotate away unless needed.`,why:`Lower Phase 2 priority.`},final:{priority:`Low`,strategy:`Hold as a secondary objective.`,why:`Medium Phase 3 support value.`}}},{id:`transit`,name:`Transit Station`,x:60,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Major mobility advantage.`},mid:{priority:`Medium`,strategy:`Hold if practical.`,why:`Medium Phase 2 rotation value.`},final:{priority:`Low`,strategy:`Use only when needed for rotations.`,why:`Lower Phase 3 priority.`}}}]})),O,k,re,A,ie=i((()=>{O=`modulepreload`,k=function(e){return`/`+e},re={},A=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=k(t,n),t=s(t),t in re)return;re[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:O,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));function j(){return ae().length===0}function ae(){return Object.entries(ce).filter(([,e])=>!e).map(([e])=>e)}function M(){return{configured:j(),missingKeys:ae()}}async function oe(){if(!j())return null;if(!P){let{initializeApp:e}=await A(async()=>{let{initializeApp:e}=await import(`./index.esm-Df048VV9.js`);return{initializeApp:e}},__vite__mapDeps([0,1]));P=e(N)}return P}async function se(){if(!j())return null;if(!F){let[e,{getFirestore:t}]=await Promise.all([oe(),A(()=>import(`./index.esm-CiS3u4qK.js`),__vite__mapDeps([2,1]))]);F=t(e)}return F}var N,ce,P,F,le=i((()=>{ie(),N={apiKey:`AIzaSyDnOfdz8WQsvxr5oJaFzS8EdNJtdsQYgqQ`,authDomain:`wos-command-center.firebaseapp.com`,projectId:`wos-command-center`,storageBucket:`wos-command-center.firebasestorage.app`,messagingSenderId:`853155306331`,appId:`1:853155306331:web:f37dc257fa6950d0f2d87e`},ce={VITE_FIREBASE_API_KEY:N.apiKey,VITE_FIREBASE_PROJECT_ID:N.projectId,VITE_FIREBASE_APP_ID:N.appId},P=null,F=null}));function ue(){let e=globalThis.location?.hostname;return e===`localhost`||e===`127.0.0.1`||e===``}function de(e,t){if(!e.exists())return z[t];let n=e.data();return Array.isArray(z[t])?Array.isArray(n.items)?n.items:z[t]:n.value??n}function fe(e,t){return Promise.race([e,new Promise((e,n)=>{setTimeout(()=>n(Error(t)),Ce)})])}function pe(e){return e?.code===`unavailable`||e?.message?.toLowerCase().includes(`client is offline`)||e?.message?.toLowerCase().includes(`offline`)}function me(e){return pe(e)?Error(`Combatants were not saved. Firestore is configured, but the app cannot reach Firebase from this browser. Check network access, Firestore setup, and Firebase Hosting env build settings.`):Error(`Combatants were not saved to Firebase. ${e.message}`)}async function he(){if(!j()){if(!ue()){let e=M();console.warn(`Firebase is not configured. Using bundled local data fallback.`,e.missingKeys)}return z}try{let[e,{doc:t,getDoc:n}]=await Promise.all([se(),A(()=>import(`./index.esm-CiS3u4qK.js`),__vite__mapDeps([2,1]))]);if(!e)return z;let r=await Promise.all(Object.entries(Se).map(async([r,i])=>[r,de(await fe(n(t(e,xe,i)),`Timed out loading ${i} from Firebase.`),r)]));z={...z,...Object.fromEntries(r)}}catch(e){console.warn(`Using bundled command data fallback.`,e)}return z}async function ge(e,t){let n=Se[e];if(!n)throw Error(`Unknown command data key: ${e}`);if(!j()){if(!ue()){let e=M();throw Error(`Firebase is not configured. Missing: ${e.missingKeys.join(`, `)}. Production combatant changes cannot be saved.`)}return z={...z,[e]:t},z[e]}let[r,{doc:i,serverTimestamp:a,setDoc:o}]=await Promise.all([se(),A(()=>import(`./index.esm-CiS3u4qK.js`),__vite__mapDeps([2,1]))]);if(!r)return z={...z,[e]:t},z[e];let s=Array.isArray(t)?{items:t}:{value:t};try{await fe(o(i(r,xe,n),{...s,updatedAt:a()},{merge:!0}),`Timed out saving ${n} to Firebase.`)}catch(e){throw me(e)}return z={...z,[e]:t},z[e]}function _e(){return z.chiefs}function ve(){return z.combatants}function I(){let e=ve();return e.length>0?e.map(e=>({...e,displayName:e.name,source:`combatants`})):_e().map(e=>({...e,name:e.displayName,source:`chiefs`}))}function L(e){return I().find(t=>t.id===e)}function ye(){return z.foundryAssignments}function be(){return z.foundryConfig}function R(){return z.foundryObjectives}var z,xe,Se,Ce,B=i((()=>{S(),w(),ee(),ne(),D(),le(),ie(),z={chiefs:x,combatants:C,foundryAssignments:T,foundryConfig:te,foundryObjectives:E},xe=`commandData`,Se={chiefs:`chiefs`,combatants:`combatants`,foundryAssignments:`foundryAssignments`,foundryConfig:`foundryConfig`,foundryObjectives:`foundryObjectives`},Ce=8e3}));function we(e,t){if(!e)return[];let n=[],r=Oe(e,t);r.length>0&&n.push(...r);let i=ye()[t];return i&&Object.entries(i).forEach(([t,r])=>{r.forEach(r=>{r.chief===e&&n.push({objectiveId:t,assignment:r.assignment})})}),n}function Te(e,t,n){return we(e,t).find(e=>e.objectiveId===n)}function Ee(e,t,n=null){return I().filter(e=>e.source===`combatants`&&(!n||e.legion===n)).map(e=>({combatant:e,assignments:Oe(e.id,t)})).flatMap(t=>t.assignments.filter(t=>t.objectiveId===e).map(e=>({combatant:t.combatant,assignment:e})))}function De(e,t){let n=new Map;return I().filter(t=>t.source===`combatants`&&t.legion===e).forEach(e=>{Oe(e.id,t).forEach(t=>{t.objectiveId&&(n.has(t.objectiveId)||n.set(t.objectiveId,[]),n.get(t.objectiveId).push({combatant:e,assignment:t}))})}),[...n.entries()].map(([e,t])=>({objectiveId:e,assignments:t}))}function Oe(e,t){let n=L(e);if(!n||n.source!==`combatants`)return[];let r=n.assignment?.trim();if(!r||V(r)===`no engagement`)return[];let i=ke(r);return i?Ae(n,i,t).map((e,t)=>({objectiveId:e,assignment:`${r} primary ${t+1}`,combatant:n})):[{objectiveId:Qe(r),assignment:r,combatant:n}]}function ke(e){let t=V(e);return t===`legion 1`?1:t===`legion 2`?2:null}function Ae(e,t,n){return je(t,n).get(e.id)??[]}function je(e,t){let n=t??`opening`,r=Me(e,n),i=Xe(e),a=new Map(i.map(e=>[e.id,[]]));if(r.length===0||i.length===0)return a;let o=Ne(r,n),s=Ke(r,n,i.length),c=new Map(r.map(e=>[e.id,0]));for(let t=0;t<et;t+=1)i.forEach(t=>{let n=a.get(t.id),i=Ye(t,e)?Ve(o):o,l=Pe(r,n,c,s)??Fe(i,n,c,s);l&&(n.push(l.id),c.set(l.id,(c.get(l.id)??0)+1))});return a}function Me(e,t){return($e[t]?.[e]??[]).map(e=>R().find(t=>t.id===e)).filter(Boolean)}function Ne(e,t){let n=[];for(let r=0;r<e.length-2;r+=1)for(let i=r+1;i<e.length-1;i+=1)for(let a=i+1;a<e.length;a+=1){let o=ze([e[r],e[i],e[a]],t);n.push({objectives:o,score:Re(o,t)})}return n.sort((e,t)=>t.score-e.score)}function Pe(e,t,n,r){return Le(e).find(e=>Ie(e,t,n,r)&&(n.get(e.id)??0)===0)??null}function Fe(e,t,n,r){for(let i of e){let e=i.objectives.find(e=>Ie(e,t,n,r));if(e)return e}return null}function Ie(e,t,n,r){return t.includes(e.id)?!1:(n.get(e.id)??0)<(r.get(e.id)??0)}function Le(e){return[...e].sort((e,t)=>We(e)-We(t)||e.name.localeCompare(t.name))}function Re(e,t){let n=e.reduce((e,n)=>e+Ge(n,t),0),r=Be(e),i=Ue(e)*nt;return n*tt-r-i}function ze(e,t){return[...e].sort((e,n)=>Ge(n,t)-Ge(e,t)||e.name.localeCompare(n.name))}function Be(e){let[t,n,r]=e;return Je(t,n)*rt+Je(t,r)*rt+Je(n,r)*it}function Ve(e){return[...e].sort((e,t)=>He(t)-He(e))}function He(e){return e.score-Ue(e.objectives)*ot}function Ue(e){return e.reduce((e,t)=>e+Math.hypot(t.x-H.x,t.y-H.y),0)}function We(e){return Math.hypot(e.x-H.x,e.y-H.y)}function Ge(e,t){return st[e.phases[t]?.priority?.toLowerCase()??`low`]??st.low}function Ke(e,t,n){return new Map(e.map(e=>[e.id,qe(e,t,n)]))}function qe(e,t,n){let r=ct[e.phases[t]?.priority?.toLowerCase()??`low`]??ct.low;return Math.max(1,Math.floor(n*r))}function Je(e,t){return Math.hypot(e.x-t.x,e.y-t.y)}function Ye(e,t){let n=Xe(t),r=Math.max(1,Math.ceil(n.length*at)),i=n.findIndex(t=>t.id===e.id);return i>=0&&i>=n.length-r}function Xe(e){return I().filter(t=>t.source===`combatants`&&t.legion===e&&V(t.assignment)!==`no engagement`).sort((e,t)=>Ze(t)-Ze(e)||e.displayName.localeCompare(t.displayName))}function Ze(e){return e.troopPower??e.power??0}function Qe(e){let t=V(e);return R().find(e=>V(e.id)===t||V(e.name)===t||t.includes(V(e.name)))?.id??null}function V(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,` `).trim()}var $e,et,tt,nt,rt,it,at,ot,H,st,ct,lt=i((()=>{B(),$e={opening:{1:[`boiler`,`prototype-west`,`prototype-east`,`repair-west`,`repair-south`,`transit`],2:[`boiler`,`repair-north`,`prototype-west`,`prototype-east`,`repair-east`,`transit`]},mid:{1:[`boiler`,`prototype-west`,`prototype-east`,`repair-west`,`repair-south`,`mercenary`,`munitions`,`imperial`,`transit`],2:[`boiler`,`repair-north`,`prototype-west`,`prototype-east`,`repair-east`,`mercenary`,`munitions`,`imperial`,`transit`]},final:{1:[`boiler`,`imperial`,`prototype-west`,`prototype-east`,`munitions`,`mercenary`,`workshop-northwest`,`workshop-southwest`,`repair-west`,`repair-south`,`transit`],2:[`boiler`,`imperial`,`prototype-west`,`prototype-east`,`munitions`,`mercenary`,`workshop-northeast`,`workshop-southeast`,`repair-east`,`repair-north`,`transit`]}},et=3,tt=100,nt=.25,rt=2.5,it=1.5,at=.1,ot=2,H={x:100,y:50},st={critical:4,high:3,medium:2,low:1},ct={critical:.4,high:.35,medium:.15,low:.1}}));function ut(){let e=document.getElementById(`my-objectives`),t=Tt();if(!e)return;e.innerHTML=``;let n=t?we(t,gt()):De(Et(),gt()).map(e=>({objectiveId:e.objectiveId,assignment:`${e.assignments.length} assigned combatants`}));if(n.length===0){e.innerHTML=`<p>No assignments this phase.</p>`;return}n.forEach(t=>{let n=R().find(e=>e.id===t.objectiveId),r=document.createElement(`div`);r.className=`assignment-card`,r.innerHTML=`
    ...
    `:``}function mt(e){return e.troopPower??e.power??0}var ht=i((()=>{B(),Nt(),lt(),K()}));function gt(){return W}function _t(e){G=e}function vt(e){return{critical:`🔴`,high:`🟠`,medium:`🟡`,low:`⚪`}[e.toLowerCase()]||`⚪`}function yt(e){let t={opening:0,mid:1,final:2};return t[W]>=t[e.unlockPhase]}function U(){let e=document.getElementById(`battlefield-map`);if(!e)return;e.innerHTML=``;let t=Tt(),n=we(t,W),r=Et(),i=t?[]:De(r,W);R().forEach(r=>{let a=document.createElement(`div`);a.dataset.id=r.id,a.className=`objective`,a.style.left=r.x+`%`,a.style.top=r.y+`%`;let o=r.phases[W];a.classList.add(o.priority.toLowerCase());let s=yt(r);if(s||a.classList.add(`locked`),t){let e=n.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}else{let e=i.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}G&&G.id===r.id&&a.classList.add(`selected`),a.innerHTML=`
        ...
        `,a.onclick=()=>{G=r,U()},e.appendChild(a)}),G||=R()[0],bt(G),ft(),ut()}function bt(e){let t=document.getElementById(`objective-panel`);if(!t||!e)return;let n=e.phases[W],r=Te(Tt(),W,e.id),i=Ee(e.id,W,Et());t.innerHTML=`
    ...
    `}function St(e){return e.troopPower??e.power??0}function Ct(){let e=document.querySelectorAll(`.phase-button`);e.forEach(t=>{t.onclick=()=>{e.forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),W=t.dataset.phase,U()}})}var W,G,K=i((()=>{B(),Nt(),lt(),dt(),ht(),W=`opening`,G=null}));function wt(){let e=document.getElementById(`chief-search`),t=document.getElementById(`chief-list`);if(!e||!t)return;let n=localStorage.getItem(`chief`);if(n){let t=I().find(e=>e.id===n);t&&(q=t.id,e.value=t.displayName)}Dt(),e.addEventListener(`focus`,()=>{Ot(e.value)}),e.addEventListener(`input`,()=>{Ot(e.value),I().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase())||(q=null,localStorage.removeItem(`chief`),Dt(),U())}),e.addEventListener(`change`,()=>{let t=I().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase());if(!t){q=null,localStorage.removeItem(`chief`),Dt(),U();return}q=t.id,localStorage.setItem(`chief`,t.id),Dt(),U(),At()}),document.addEventListener(`click`,n=>{n.target===e||t.contains(n.target)||At()})}function Tt(){return q}function Et(){let e=L(q);return e?.legion?e.legion:Number.isFinite(J)?J:1}function Dt(){let e=document.getElementById(`legion-context`);if(!e)return;let t=L(q);if(t){e.innerHTML=`
            <label>Legion</label>
    ...
    `,e.querySelector(`#legion-select`).addEventListener(`change`,e=>{J=Number.parseInt(e.target.value,10),localStorage.setItem(`legion`,String(J)),U()})}function Ot(e){let t=document.getElementById(`chief-list`);if(!t)return;let n=e.trim().toLowerCase(),r=I().slice().sort((e,t)=>e.displayName.localeCompare(t.displayName)).filter(e=>!n||e.displayName.toLowerCase().includes(n));if(r.length===0){t.innerHTML=`<div class="chief-result-empty">No chiefs found.</div>`,t.hidden=!1;return}t.innerHTML=r.map(e=>`
            <button
                type="button"
                class="chief-result"
                data-chief-id="${e.id}">
        ...
        `;return}let n=[...e].sort((e,t)=>rr(t)-rr(e));t.innerHTML=`
        <div class="card">
    ...
    `;let r=document.getElementById(`roster-list`);n.forEach(e=>{let t=document.createElement(`div`);t.className=`roster-row`,t.innerHTML=`
            <span>${e.name}</span>
            <span>${rr(e).toLocaleString()}</span>
            <span>${e.foundryAssignment??e.assignment??``}</span>
            <span>${e.canyonAssignment??``}</span>
        `,r.appendChild(t)})}function rr(e){return e.troopPower??e.power??0}var ir=i((()=>{}));function ar(){let e=document.getElementById(`import-page`);e&&(e.innerHTML=`
        <div class="card">
    ...
    `,document.getElementById(`process-images`).addEventListener(`click`,async()=>{let e=document.getElementById(`event-select`).value,t=[...document.getElementById(`combatant-upload`).files];if(t.length===0){alert(`Please select one or more screenshots.`);return}let n=document.getElementById(`import-results`);n.innerHTML=`<p>Processing...</p>`;try{let r=await er(e,t);$=r.flatMap(e=>e.combatants??[]).map(pr),sr(n,r)}catch(e){console.error(e),n.innerHTML=`
                    <p class="error">
                        ${e.message}
                    </p>
                ...
                ${e.map((e,t)=>`
                    <div class="review-row">
                        ...
                        <div class="review-assignment-options">
                            ${Z(t,e,`foundryAssignment`,`Legion 1`)}
                            ${Z(t,e,`foundryAssignment`,`Legion 2`)}
                            ${Z(t,e,`foundryAssignment`,`No engagement`)}
                        </div>

                        <div class="review-assignment-options">
                            ${Z(t,e,`canyonAssignment`,`Legion 1`)}
                            ${Z(t,e,`canyonAssignment`,`Legion 2`)}
                            ${Z(t,e,`canyonAssignment`,`No engagement`)}
                        </div>
                        ...
                        <input
                            ...
                            inputmode="numeric"
                            value="${Q(String(e.heroTotalPower??``))}">

                        <input
                            data-review-index="${t}"
                            data-review-field="labyrinthLevels"
                            inputmode="numeric"
                            value="${Q(String(e.labyrinthLevels??``))}">
    ...
    `}function Z(e,t,n,r){let i=gr(n===`foundryAssignment`?vr(t):t[n]);return`
