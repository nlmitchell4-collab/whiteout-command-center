...
var e=Object.defineProperty,t=Object.getOwnPropertyDescriptor,n=Object.getOwnPropertyNames,r=Object.prototype.hasOwnProperty,i=(e,t,n)=>()=>{if(n)throw n[0];try{return e&&(t=e(e=0)),t}catch(e){throw n=[e],e}},a=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),o=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r},s=(i,a,o,s)=>{if(a&&typeof a==`object`||typeof a==`function`)for(var c=n(a),l=0,u=c.length,d;l<u;l++)d=c[l],!r.call(i,d)&&d!==o&&e(i,d,{get:(e=>a[e]).bind(null,d),enumerable:!(s=t(a,d))||s.enumerable});return i},c=t=>r.call(t,`module.exports`)?t[`module.exports`]:s(e({},`__esModule`,{value:!0}),t),l=(e=>typeof require<`u`?require:typeof Proxy<`u`?new Proxy(e,{get:(e,t)=>(typeof require<`u`?require:e)[t]}):e)(function(e){if(typeof require<`u`)return require.apply(this,arguments);throw Error('Calling `require` for "'+e+"\" in an environment that doesn't expose the `require` function. See https://rolldown.rs/in-depth/bundling-cjs#require-external-modules for more details.")});(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var u=i((()=>{}));function d(){return sessionStorage.getItem(`admin`)===`true`}function f(e){return e===p?(sessionStorage.setItem(`admin`,`true`),!0):!1}var p,m=i((()=>{p=`NWOFoundry2026`}));function h(e){let t=prompt(`Administrator Password`);t!==null&&(f(t)?e():alert(`Incorrect password.`))}var g=i((()=>{m()}));function _(){let e=document.querySelectorAll(`.page`),t=document.querySelectorAll(`.nav-button`);t.forEach(n=>{n.addEventListener(`click`,()=>{let r=()=>{e.forEach(e=>e.classList.remove(`active`)),t.forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),document.getElementById(n.dataset.page).classList.add(`active`)};if(n.dataset.page===`import`&&!d()){h(r);return}r()})})}var v=i((()=>{m(),g()})),y,b=i((()=>{y=[{id:`nick`,displayName:`Nicholas`},{id:`kazuma`,displayName:`Kazuma`},{id:`nooch`,displayName:`Nooch`}]})),x,S=i((()=>{x=[]})),C,w=i((()=>{C={opening:{boiler:[{chief:`nick`,assignment:`Lead`},{chief:`kazuma`,assignment:`Support`}],"workshop-west":[{chief:`nooch`,assignment:`Lead`}],"prototype-west":[]},mid:{"prototype-west":[{chief:`nick`,assignment:`Lead`}],"prototype-east":[{chief:`kazuma`,assignment:`Lead`}],mercenary:[{chief:`nooch`,assignment:`Lead`}]},final:{imperial:[{chief:`nick`,assignment:`Support`}]}}})),T,ee=i((()=>{T={strategyName:`Legion 2 Standard`,version:`0.2.0`,commander:`Kazuma`,eventDate:``,eventDuration:60,phases:{opening:{label:`0–15 Minutes`},mid:{label:`15–45 Minutes`},final:{label:`45 Minutes–End`}}}})),E,te=i((()=>{E=[{id:`boiler`,name:`Boiler`,x:30,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Building capture speed buff.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`Still valuable throughout the match.`},final:{priority:`Medium`,strategy:`Defend only if nearby.`,why:`Imperial takes priority.`}}},{id:`repair-north`,name:`North Repair`,x:58,y:5,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if available.`,why:`Extra points.`},mid:{priority:`Medium`,strategy:`Maintain if uncontested.`,why:`Secondary objective.`},final:{priority:`Low`,strategy:`Abandon if needed.`,why:`Imperial comes first.`}}},{id:`workshop-northwest`,name:`NW Workshop`,x:20,y:15,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture early.`,why:`Combat buffs.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`Supports Prototype.`},final:{priority:`Medium`,strategy:`Hold if practical.`,why:`Secondary objective.`}}},{id:`mercenary`,name:`Mercenary Camp`,x:45,y:15,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`High`,strategy:`Capture immediately.`,why:`High point value.`},final:{priority:`Medium`,strategy:`Hold if uncontested.`,why:`Support objective.`}}},{id:`workshop-northeast`,name:`NE Workshop`,x:70,y:20,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture early.`,why:`Combat buffs.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`Supports Prototype.`},final:{priority:`Medium`,strategy:`Hold if practical.`,why:`Secondary objective.`}}},{id:`prototype-west`,name:`West Prototype`,x:20,y:30,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Major scoring objective.`},mid:{priority:`Critical`,strategy:`Hold at all costs.`,why:`Excellent point generation.`},final:{priority:`Critical`,strategy:`Never abandon unless ordered.`,why:`Still one of the highest priorities.`}}},{id:`repair-west`,name:`West Repair`,x:10,y:40,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Medium`,strategy:`Maintain if uncontested.`,why:`Useful support.`},final:{priority:`Low`,strategy:`Ignore if needed.`,why:`Imperial first.`}}},{id:`imperial`,name:`Imperial Institute`,x:45,y:35,unlockPhase:`final`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Low`,strategy:`Prepare rotation.`,why:`Unlocks in Final.`},final:{priority:`Critical`,strategy:`Primary objective.`,why:`Highest value objective.`}}},{id:`repair-east`,name:`East Repair`,x:80,y:35,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Medium`,strategy:`Maintain if uncontested.`,why:`Useful support.`},final:{priority:`Low`,strategy:`Ignore if needed.`,why:`Imperial first.`}}},{id:`prototype-east`,name:`East Prototype`,x:70,y:45,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Major scoring objective.`},mid:{priority:`Critical`,strategy:`Hold at all costs.`,why:`Excellent point generation.`},final:{priority:`Critical`,strategy:`Never abandon unless ordered.`,why:`Still one of the highest priorities.`}}},{id:`workshop-southwest`,name:`SW Workshop`,x:26,y:55,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture early.`,why:`Combat buffs.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`Supports Transit.`},final:{priority:`Medium`,strategy:`Hold if practical.`,why:`Secondary objective.`}}},{id:`workshop-southeast`,name:`SE Workshop`,x:61,y:60,unlockPhase:`opening`,phases:{opening:{priority:`High`,strategy:`Capture early.`,why:`Combat buffs.`},mid:{priority:`High`,strategy:`Maintain control.`,why:`Supports Transit.`},final:{priority:`Medium`,strategy:`Hold if practical.`,why:`Secondary objective.`}}},{id:`munitions`,name:`Munitions Factory`,x:45,y:60,unlockPhase:`mid`,phases:{opening:{priority:`Low`,strategy:`Locked.`,why:`Unavailable.`},mid:{priority:`Critical`,strategy:`Capture immediately.`,why:`Powerful combat buff.`},final:{priority:`High`,strategy:`Maintain control.`,why:`Strong late-game buff.`}}},{id:`repair-south`,name:`South Repair`,x:31,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Medium`,strategy:`Capture if nearby.`,why:`Additional points.`},mid:{priority:`Medium`,strategy:`Maintain if uncontested.`,why:`Useful support.`},final:{priority:`Low`,strategy:`Ignore if needed.`,why:`Imperial first.`}}},{id:`transit`,name:`Transit Station`,x:60,y:75,unlockPhase:`opening`,phases:{opening:{priority:`Critical`,strategy:`Capture immediately.`,why:`Major mobility advantage.`},mid:{priority:`Critical`,strategy:`Maintain control.`,why:`Fast rotations.`},final:{priority:`High`,strategy:`Support Imperial.`,why:`Quick reinforcement.`}}}]})),D,O,k,A,ne=i((()=>{D=`modulepreload`,O=function(e){return`/`+e},k={},A=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=O(t,n),t=s(t),t in k)return;k[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:D,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})}}));function j(){return re().length===0}function re(){return Object.entries(oe).filter(([,e])=>!e).map(([e])=>e)}function ie(){return{configured:j(),missingKeys:re()}}async function ae(){if(!j())return null;if(!P){let{initializeApp:e}=await A(async()=>{let{initializeApp:e}=await import(`./index.esm-IMia6DUj.js`);return{initializeApp:e}},__vite__mapDeps([0,1]));P=e(N)}return P}async function M(){if(!j())return null;if(!F){let[e,{getFirestore:t}]=await Promise.all([ae(),A(()=>import(`./index.esm-DJzaB7_V.js`),__vite__mapDeps([2,1]))]);F=t(e)}return F}var N,oe,P,F,se=i((()=>{ne(),N={apiKey:`AIzaSyDnOfdz8WQsvxr5oJaFzS8EdNJtdsQYgqQ`,authDomain:`wos-command-center.firebaseapp.com`,projectId:`wos-command-center`,storageBucket:`wos-command-center.firebasestorage.app`,messagingSenderId:`853155306331`,appId:`1:853155306331:web:f37dc257fa6950d0f2d87e`},oe={VITE_FIREBASE_API_KEY:N.apiKey,VITE_FIREBASE_PROJECT_ID:N.projectId,VITE_FIREBASE_APP_ID:N.appId},P=null,F=null}));function ce(){let e=globalThis.location?.hostname;return e===`localhost`||e===`127.0.0.1`||e===``}function le(e,t){if(!e.exists())return z[t];let n=e.data();return Array.isArray(z[t])?Array.isArray(n.items)?n.items:z[t]:n.value??n}function ue(e,t){return Promise.race([e,new Promise((e,n)=>{setTimeout(()=>n(Error(t)),xe)})])}function de(e){return e?.code===`unavailable`||e?.message?.toLowerCase().includes(`client is offline`)||e?.message?.toLowerCase().includes(`offline`)}function fe(e){return de(e)?Error(`Combatants were not saved. Firestore is configured, but the app cannot reach Firebase from this browser. Check network access, Firestore setup, and Firebase Hosting env build settings.`):Error(`Combatants were not saved to Firebase. ${e.message}`)}async function pe(){if(!j()){if(!ce()){let e=ie();console.warn(`Firebase is not configured. Using bundled local data fallback.`,e.missingKeys)}return z}try{let[e,{doc:t,getDoc:n}]=await Promise.all([M(),A(()=>import(`./index.esm-DJzaB7_V.js`),__vite__mapDeps([2,1]))]);if(!e)return z;let r=await Promise.all(Object.entries(be).map(async([r,i])=>[r,le(await ue(n(t(e,ye,i)),`Timed out loading ${i} from Firebase.`),r)]));z={...z,...Object.fromEntries(r)}}catch(e){console.warn(`Using bundled command data fallback.`,e)}return z}async function me(e,t){let n=be[e];if(!n)throw Error(`Unknown command data key: ${e}`);if(!j()){if(!ce()){let e=ie();throw Error(`Firebase is not configured. Missing: ${e.missingKeys.join(`, `)}. Production combatant changes cannot be saved.`)}return z={...z,[e]:t},z[e]}let[r,{doc:i,serverTimestamp:a,setDoc:o}]=await Promise.all([M(),A(()=>import(`./index.esm-DJzaB7_V.js`),__vite__mapDeps([2,1]))]);if(!r)return z={...z,[e]:t},z[e];let s=Array.isArray(t)?{items:t}:{value:t};try{await ue(o(i(r,ye,n),{...s,updatedAt:a()},{merge:!0}),`Timed out saving ${n} to Firebase.`)}catch(e){throw fe(e)}return z={...z,[e]:t},z[e]}function he(){return z.chiefs}function ge(){return z.combatants}function I(){let e=ge();return e.length>0?e.map(e=>({...e,displayName:e.name,source:`combatants`})):he().map(e=>({...e,name:e.displayName,source:`chiefs`}))}function L(e){return I().find(t=>t.id===e)}function _e(){return z.foundryAssignments}function ve(){return z.foundryConfig}function R(){return z.foundryObjectives}var z,ye,be,xe,B=i((()=>{b(),S(),w(),ee(),te(),se(),ne(),z={chiefs:y,combatants:x,foundryAssignments:C,foundryConfig:T,foundryObjectives:E},ye=`commandData`,be={chiefs:`chiefs`,combatants:`combatants`,foundryAssignments:`foundryAssignments`,foundryConfig:`foundryConfig`,foundryObjectives:`foundryObjectives`},xe=8e3}));function V(e,t){if(!e)return[];let n=[],r=Te(e,t);r.length>0&&n.push(...r);let i=_e()[t];return i&&Object.entries(i).forEach(([t,r])=>{r.forEach(r=>{r.chief===e&&n.push({objectiveId:t,assignment:r.assignment})})}),n}function Se(e,t,n){return V(e,t).find(e=>e.objectiveId===n)}function Ce(e,t,n=null){return I().filter(e=>e.source===`combatants`&&(!n||e.legion===n)).map(e=>({combatant:e,assignments:Te(e.id,t)})).flatMap(t=>t.assignments.filter(t=>t.objectiveId===e).map(e=>({combatant:t.combatant,assignment:e})))}function we(e,t){let n=new Map;return I().filter(t=>t.source===`combatants`&&t.legion===e).forEach(e=>{Te(e.id,t).forEach(t=>{t.objectiveId&&(n.has(t.objectiveId)||n.set(t.objectiveId,[]),n.get(t.objectiveId).push({combatant:e,assignment:t}))})}),[...n.entries()].map(([e,t])=>({objectiveId:e,assignments:t}))}function Te(e,t){let n=L(e);if(!n||n.source!==`combatants`)return[];let r=n.assignment?.trim();if(!r||H(r)===`no engagement`)return[];let i=Ee(r);return i?De(n,i,t).map((e,t)=>({objectiveId:e,assignment:`${r} primary ${t+1}`,combatant:n})):[{objectiveId:Pe(r),assignment:r,combatant:n}]}function Ee(e){let t=H(e);return t===`legion 1`?1:t===`legion 2`?2:null}function De(e,t,n){let r=n??`opening`,i=Oe(t,r);if(i.length<=Ie)return i.map(e=>e.id);let a=ke(i,r);return a[Ne(e,t)%a.length].objectives.map(e=>e.id)}function Oe(e,t){return(Fe[t]?.[e]??[]).map(e=>R().find(t=>t.id===e)).filter(Boolean)}function ke(e,t){let n=[];for(let r=0;r<e.length-2;r+=1)for(let i=r+1;i<e.length-1;i+=1)for(let a=i+1;a<e.length;a+=1){let o=[e[r],e[i],e[a]];n.push({objectives:o,score:Ae(o,t)})}return n.sort((e,t)=>t.score-e.score)}function Ae(e,t){let n=e.reduce((e,n)=>e+je(n,t),0),r=Me(e[0],e[1])+Me(e[0],e[2])+Me(e[1],e[2]);return n*100-r}function je(e,t){return Le[e.phases[t]?.priority?.toLowerCase()??`low`]??Le.low}function Me(e,t){return Math.hypot(e.x-t.x,e.y-t.y)}function Ne(e,t){let n=I().filter(e=>e.source===`combatants`&&e.legion===t&&H(e.assignment)!==`no engagement`).sort((e,t)=>(t.power??0)-(e.power??0)||e.displayName.localeCompare(t.displayName));return Math.max(0,n.findIndex(t=>t.id===e.id))}function Pe(e){let t=H(e);return R().find(e=>H(e.id)===t||H(e.name)===t||t.includes(H(e.name)))?.id??null}function H(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,` `).trim()}var Fe,Ie,Le,Re=i((()=>{B(),Fe={opening:{1:[`boiler`,`workshop-northwest`,`prototype-west`,`repair-west`,`workshop-southwest`,`repair-south`,`transit`],2:[`boiler`,`repair-north`,`workshop-northeast`,`prototype-east`,`repair-east`,`workshop-southeast`,`transit`]},mid:{1:[`boiler`,`workshop-northwest`,`prototype-west`,`repair-west`,`workshop-southwest`,`repair-south`,`mercenary`,`munitions`,`transit`],2:[`boiler`,`repair-north`,`workshop-northeast`,`prototype-east`,`repair-east`,`workshop-southeast`,`mercenary`,`munitions`,`transit`]},final:{1:[`prototype-west`,`workshop-southwest`,`repair-west`,`repair-south`,`imperial`,`transit`],2:[`prototype-east`,`workshop-southeast`,`repair-east`,`repair-north`,`imperial`,`transit`]}},Ie=3,Le={critical:4,high:3,medium:2,low:1}}));function ze(){let e=document.getElementById(`my-objectives`),t=$e();if(!e)return;e.innerHTML=``;let n=t?V(t,We()):we(et(),We()).map(e=>({objectiveId:e.objectiveId,assignment:`${e.assignments.length} assigned combatants`}));if(n.length===0){e.innerHTML=`<p>No assignments this phase.</p>`;return}n.forEach(t=>{let n=R().find(e=>e.id===t.objectiveId),r=document.createElement(`div`);r.className=`assignment-card`,r.innerHTML=`
    ...
    `;let s=document.getElementById(`summary-list`);a.forEach(e=>{let t=R().find(t=>t.id===e.objectiveId);s.innerHTML+=`
        ...
        `})}function He(e){return e.source===`combatants`?`
        <p>
            ${e.power?`${e.power.toLocaleString()} power`:``}
            ${e.legion?` | Legion ${e.legion}`:``}
        </p>
    `:``}var Ue=i((()=>{B(),Y(),Re(),Ze()}));function We(){return W}function Ge(e){G=e}function Ke(e){return{critical:`🔴`,high:`🟠`,medium:`🟡`,low:`⚪`}[e.toLowerCase()]||`⚪`}function qe(e){let t={opening:0,mid:1,final:2};return t[W]>=t[e.unlockPhase]}function U(){let e=document.getElementById(`battlefield-map`);if(!e)return;e.innerHTML=``;let t=$e(),n=V(t,W),r=et(),i=t?[]:we(r,W);R().forEach(r=>{let a=document.createElement(`div`);a.dataset.id=r.id,a.className=`objective`,a.style.left=r.x+`%`,a.style.top=r.y+`%`;let o=r.phases[W];a.classList.add(o.priority.toLowerCase());let s=qe(r);if(s||a.classList.add(`locked`),t){let e=n.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}else{let e=i.some(e=>e.objectiveId===r.id);a.classList.add(e?`assigned`:`unassigned`)}G&&G.id===r.id&&a.classList.add(`selected`),a.innerHTML=`
        ...
        `,a.onclick=()=>{G=r,U()},e.appendChild(a)}),G||=R()[0],Je(G),Ve(),ze()}function Je(e){let t=document.getElementById(`objective-panel`);if(!t||!e)return;let n=e.phases[W],r=Se($e(),W,e.id),i=Ce(e.id,W,et());t.innerHTML=`
    ...
    `}function Ye(e){return e.length===0?`<p>No combatants assigned.</p>`:`
    ...
    `}function Xe(){let e=document.querySelectorAll(`.phase-button`);e.forEach(t=>{t.onclick=()=>{e.forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),W=t.dataset.phase,U()}})}var W,G,Ze=i((()=>{B(),Y(),Re(),Be(),Ue(),W=`opening`,G=null}));function Qe(){let e=document.getElementById(`chief-search`),t=document.getElementById(`chief-list`);if(!e||!t)return;let n=localStorage.getItem(`chief`);if(n){let t=I().find(e=>e.id===n);t&&(q=t.id,e.value=t.displayName)}K(),e.addEventListener(`focus`,()=>{tt(e.value)}),e.addEventListener(`input`,()=>{tt(e.value),I().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase())||(q=null,localStorage.removeItem(`chief`),K(),U())}),e.addEventListener(`change`,()=>{let t=I().find(t=>t.displayName.toLowerCase()===e.value.toLowerCase());if(!t){q=null,localStorage.removeItem(`chief`),K(),U();return}q=t.id,localStorage.setItem(`chief`,t.id),K(),U(),rt()}),document.addEventListener(`click`,n=>{n.target===e||t.contains(n.target)||rt()})}function $e(){return q}function et(){let e=L(q);return e?.legion?e.legion:Number.isFinite(J)?J:1}function K(){let e=document.getElementById(`legion-context`);if(!e)return;let t=L(q);if(t){e.innerHTML=`
            <label>Legion</label>
    ...
    `,e.querySelector(`#legion-select`).addEventListener(`change`,e=>{J=Number.parseInt(e.target.value,10),localStorage.setItem(`legion`,String(J)),U()})}function tt(e){let t=document.getElementById(`chief-list`);if(!t)return;let n=e.trim().toLowerCase(),r=I().slice().sort((e,t)=>e.displayName.localeCompare(t.displayName)).filter(e=>!n||e.displayName.toLowerCase().includes(n));if(r.length===0){t.innerHTML=`<div class="chief-result-empty">No chiefs found.</div>`,t.hidden=!1;return}t.innerHTML=r.map(e=>`
            <button
                type="button"
                class="chief-result"
                data-chief-id="${e.id}">
    ...
    `,document.getElementById(`process-images`).addEventListener(`click`,async()=>{let e=document.getElementById(`event-select`).value,t=[...document.getElementById(`combatant-upload`).files];if(t.length===0){alert(`Please select one or more screenshots.`);return}let n=document.getElementById(`import-results`);n.innerHTML=`<p>Processing...</p>`;try{let r=await Tn(e,t);$=r.flatMap(e=>e.combatants??[]).map(In),kn(n,r)}catch(e){console.error(e),n.innerHTML=`
                    <p class="error">
                        ${e.message}
                    </p>
                `}}),document.getElementById(`load-current-combatants`).addEventListener(`click`,()=>{let e=document.getElementById(`import-results`);$=ge().map(In),On(e)}))}function On(e){e.innerHTML=`
        ...
        ${An($)}
    `,Mn(e)}function kn(e,t){e.innerHTML=`
        ${t.map(e=>`
            <div class="ocr-result">
    ...
    `}function jn(e,t,n){let r=zn(t.assignment);return`
    ...
    `}function Mn(e){e.querySelectorAll(`[data-review-index]`).forEach(e=>{e.addEventListener(`change`,()=>{Nn(e)})}),e.querySelectorAll(`[data-remove-review-index]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number.parseInt(e.dataset.removeReviewIndex,10);$.splice(t,1);let n=document.getElementById(`import-results`);n.innerHTML=An($),Mn(n)})});let t=e.querySelector(`#save-reviewed-combatants`),n=e.querySelector(`#add-reviewed-combatant`);n&&n.addEventListener(`click`,()=>{$.push(Ln()),On(document.getElementById(`import-results`))}),t&&t.addEventListener(`click`,async()=>{let t=e.querySelector(`#review-save-status`);t.textContent=`Saving...`;try{await me(`combatants`,$.map(Fn)),t.textContent=`Saved.`}catch(e){console.error(e),t.textContent=e.message}})}function Nn(e){let t=Number.parseInt(e.dataset.reviewIndex,10),n=e.dataset.reviewField;!$[t]||!n||($[t]={...$[t],[n]:Pn(n,e.value)})}function Pn(e,t){if(e===`power`){let e=Number.parseInt(String(t).replace(/,/g,``),10);return Number.isFinite(e)?e:null}return t.trim()}function Fn(e){let t=e.name?.trim()??``,n=zn(e.assignment);return{...e,id:Vn(t),name:t,power:Number.parseInt(e.power,10)||0,legion:Bn(n),assignment:n}}function In(e){return{...e,assignment:e.assignment??Rn(e)}}function Ln(){return{id:``,name:``,power:0,legion:null,assignment:`No engagement`,status:``,engagement:``,sourceFile:`manual`,sourceRow:null,sourceY:null}}function Rn(e){return e.legion?`Legion ${e.legion}`:`No engagement`}function zn(e){return e===`Legion 1`||e===`Legion 2`?e:`No engagement`}function Bn(e){return e===`Legion 1`?1:e===`Legion 2`?2:null}function Vn(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function Hn(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`)}function Q(e){return Hn(e)}var $,Un=i((()=>{En(),B(),$=[]}));async function Wn(){_(),Dn(),await Gn(),Qe(),Xe(),U()}async function Gn(){try{await Promise.race([pe(),new Promise((e,t)=>{setTimeout(()=>t(Error(`Command data load timed out.`)),6e3)})])}catch(e){console.warn(`Using available command data fallback.`,e)}}var Kn=i((()=>{v(),B(),Y(),Ze(),Un(),document.addEventListener(`DOMContentLoaded`,()=>{Wn()})}));a((()=>{u(),Kn(),Y(),se(),Un(),document.addEventListener(`DOMContentLoaded`,()=>{})}))();export{i as t};